...
function Navbar() {
  ...
  return (
    <>
    <div className="navbar bg-base-100 max-w-full fixed top-0 left-0  z-50 bg-slate-100 dark:bg-slate-900 dark:text-white ">
  ...
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1 mx-1  ">
      ...
      <li><a   href='/' className=' text-black rounded-md  border-black dark:text-white ' >Home</a></li>
      <li><a  href='/Course 'className=' text-black rounded-md border-black dark:text-white  '>Courses</a></li>
      <li><a  href='/contact' className=' text-black rounded-md  border-black  dark:text-white'>Contact</a></li>
